<template>
  <div v-show="visible">
    ...
    <div class="modal-wrap">
      <div class="modal-doc" :style="mStyle">
        <div class="modal-content animation-up">
          <button class="modal-close" @click="cancelFun">X</button>
          <div class="modal-header">
            <div class="modal-title">{{title}}</div>
          </div>
          <div class="modal-body"><div v-html="`<div>${content}</div>`"></div></div>
          <div class="modal-footer">
            <Button :text="okText" :primary="true" @click="okFun"></Button>
            <Button :text="cancelText" @click="cancelFun"></Button>
          </div>
        </div>
      </div>
    </div>
